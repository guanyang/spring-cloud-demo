...
import org.gy.framework.demoutil.json.JacksonMapper;
...
public class ResponseUtil {
    ...
    public static void ajaxJson(HttpServletRequest request,
                                ...
                                Object object) {
        ajaxJson(request, response, JacksonMapper.beanToJson(object));
    }
     ...
     * @param jsonString json字符串
     */
    private static void ajaxJson(HttpServletResponse response,
                                 String jsonString) {
     ...
     * @param type     输出格式
     */
    private static void ajax(HttpServletResponse response,
                             String content,
                             String contentType) {
        try {
